  ...
  Yolk.prototype.modules = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4, /*yield*/ this.execute(module.modules())];
          case 1:
            return [2, /*return*/ _a.sent()];
        }
      });
  ...
  Yolk.prototype.moduleByName = function (name) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4, /*yield*/ this.execute(module.moduleByName(name))];
          case 1:
            return [2, /*return*/ _a.sent()];
        }
      });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4, /*yield*/
              this.execute(module.moduleUploadByVersion(name, version)),
            ];
          case 1:
            return [2, /*return*/ _a.sent()];
        }
  ...
  Yolk.prototype.user = function (apiKey) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4, /*yield*/ this.execute(user.user(apiKey))];
          case 1:
            return [2, /*return*/ _a.sent()];
        }
      });
  ...
  Yolk.prototype.userByName = function (name) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4, /*yield*/ this.execute(user.userByName(name))];
          case 1:
            return [2, /*return*/ _a.sent()];
        }
      });
  ...
  Yolk.prototype.users = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4, /*yield*/ this.execute(user.users())];
          case 1:
            return [2, /*return*/ _a.sent()];
        }
      });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4, /*yield*/
              this.execute(userMutation.createUser(user.name, user.password)),
            ];
          case 1:
            return [2, /*return*/ _a.sent()];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4, /*yield*/
              this.execute(moduleMutation.publish(newModule)),
            ];
          case 1:
            createEntry = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            _b.apply(_a, [_c.sent()]);
            return [4, /*yield*/ res.json()["catch"](console.error)];
          case 3:
